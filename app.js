const github = document.querySelector(".boxContainer")
const saluteTextContainer = document.querySelector(".saluteTextContainer")
const saluteImgContainer = document.querySelector(".saluteImgContainer")
const authorName = document.querySelector(".name")
const jobTitle = document.querySelectorAll(".jobTitleContainer")
...
window.addEventListener("scroll", ()=> {
    ...
    jobTitle[0].style.backgroundPositionY = `${offsetY * 0.5}px`
    jobTitle[1].style.backgroundPositionY = `${-offsetY * 0.5}px`
